...
print(trace_distance(noisy_init_state,init_state))
...
print(trace_distance(noisy_init_state_sym,init_state_sym))
print(trace_distance(noisy_init_state_asym,init_state_asym))
