...
# w_list,jw_list = music(signalB + 1j* signalE,-math.pi/2,math.pi/2,dt)
# np.save('w_list_noiext.npy',w_list)
# np.save('jw_list_noiext.npy',jw_list)
# # w_list = np.load('w_list.npy')
# # jw_list = np.load('jw_list.npy')
# plt.plot(w_list,jw_list,c = 'r',label = 'NoiExt')
